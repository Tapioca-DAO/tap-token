// Generated by @wagmi/cli@0.1.5 on 2/7/2023 at 7:39:32 PM
import {
    readContract,
    ReadContractConfig,
    writeContract,
...
export const yieldBoxABI = [
    ...
    },
    {
        ...
        anonymous: false,
        inputs: [
            { name: 'masterContract', internalType: 'address', type: 'address', indexed: true },
            { name: 'data', internalType: 'bytes', type: 'bytes', indexed: false },
            { name: 'cloneAddress', internalType: 'address', type: 'address', indexed: true },
        ],
        name: 'LogDeploy',
    },
    {
    ...
    },
    {
        stateMutability: 'view',
        type: 'function',
        inputs: [{ name: 'masterContract', internalType: 'address', type: 'address' }],
        name: 'clonesOfCount',
        outputs: [{ name: 'cloneCount', internalType: 'uint256', type: 'uint256' }],
    },
    {
        stateMutability: 'nonpayable',
        type: 'function',
    ...
    },
    {
        ...
        type: 'function',
        inputs: [
            { name: 'masterContract', internalType: 'address', type: 'address' },
            { name: 'data', internalType: 'bytes', type: 'bytes' },
            { name: 'useCreate2', internalType: 'bool', type: 'bool' },
        ],
        name: 'deploy',
        outputs: [{ name: 'cloneAddress', internalType: 'address', type: 'address' }],
    },
    {
        stateMutability: 'nonpayable',
        type: 'function',
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link yieldBoxABI}__ and `functionName` set to `"clonesOf"`.
 */
export function useYieldBoxClonesOf(
    config: Omit<UseContractReadConfig<typeof yieldBoxABI, 'clonesOf'>, 'abi' | 'functionName'> = {} as any,
) {
    return useContractRead({ abi: yieldBoxABI, functionName: 'clonesOf', ...config } as UseContractReadConfig<
        typeof yieldBoxABI,
        'clonesOf'
    >);
}
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link yieldBoxABI}__ and `functionName` set to `"clonesOfCount"`.
 */
export function useYieldBoxClonesOfCount(
    config: Omit<UseContractReadConfig<typeof yieldBoxABI, 'clonesOfCount'>, 'abi' | 'functionName'> = {} as any,
) {
    return useContractRead({ abi: yieldBoxABI, functionName: 'clonesOfCount', ...config } as UseContractReadConfig<
        typeof yieldBoxABI,
        'clonesOfCount'
    >);
}
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link yieldBoxABI}__ and `functionName` set to `"masterContractOf"`.
 */
export function useYieldBoxMasterContractOf(
    config: Omit<UseContractReadConfig<typeof yieldBoxABI, 'masterContractOf'>, 'abi' | 'functionName'> = {} as any,
) {
    return useContractRead({ abi: yieldBoxABI, functionName: 'masterContractOf', ...config } as UseContractReadConfig<
        typeof yieldBoxABI,
        'masterContractOf'
    >);
}
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link yieldBoxABI}__ and `functionName` set to `"totalAmounts"`.
 */
export function useYieldBoxTotalAmounts(
    config: Omit<UseContractReadConfig<typeof yieldBoxABI, 'totalAmounts'>, 'abi' | 'functionName'> = {} as any,
) {
    return useContractRead({ abi: yieldBoxABI, functionName: 'totalAmounts', ...config } as UseContractReadConfig<
        typeof yieldBoxABI,
        'totalAmounts'
    >);
}
